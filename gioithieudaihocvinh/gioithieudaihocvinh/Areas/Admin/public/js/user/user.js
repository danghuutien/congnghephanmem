    ...
    methods: {
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/Admin/User/Create", self.dataForm.data).then(function (response) {
                ...
                axios.post("/Admin/User/Edit",
                    {
                        ...
                        Phone: self.dataForm.data.Phone,
                        Password: self.dataForm.data.Password
        ...
        doAlertEdit(data) {
            ...
            self.dataForm.data.Password = data.Password;
        ...
        doAlertDelete(data) {
            ...
            this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                ...
                axios.post("/Admin/User/Delete", data)
                    .then(function (response) {
                        self.loadData();
