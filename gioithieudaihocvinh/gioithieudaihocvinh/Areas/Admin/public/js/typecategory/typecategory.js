    ...
    methods: {
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/Admin/TypeCategory/Create", self.dataForm.data).then(function (response) {
                ...
                axios.post("/Admin/TypeCategory/Edit",
                    {
                        id: self.rowId,
        ...
        doAlertDelete(data) {
            ...
            this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                ...
                axios.post("/Admin/TypeCategory/Delete", data)
                    .then(function (response) {
                        self.loadData();
